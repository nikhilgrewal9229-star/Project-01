...
<label for="Nikhil Grewal">Nikhil Grewal</label>
<input type="text" id="name" name="Nikhil Grewal" placeholder="Nikhil Grewal">
</div>
<div class="form-group">
<label for="nikhilgrewal9229@gmail.com">nikhilgrewal9229@gmail.com</label>
